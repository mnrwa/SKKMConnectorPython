...
| --- | --- | --- | --- | --- |
| product | str    | - | Название продукта | "RB-Soft:Server KKM" |
| version | str    | - | Версия сервера | "4.0.70.611" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| ServerVersion | str    | - | Версия сервера | "4.0.62.521" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| pool | str    | + | Название пула. Если пул с указанным названием не найден или в него не включено ни одно устройство, сервер возвращает пустой массив | pool |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | - | Название устройства | "Atol", <br>"Emu", <br>"Shtrih" |
...
| --- | --- | --- | --- | --- |
| Result | list[str] | - | Название пулов | "asd", <br>"dsa" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| ServerVersion | str    | - | Версия сервера ККМ | "4.0.70.0723" |
...
| TaskId | str    | - | Идентификатор текущей задачи | "24f4bffe-98ef-4627-846c-b1f74c5a495b" |
| Error | int | - | Код ошибки | 0 |
| IsBusy | bool | - | Признак занятости устройства | false |
| ErrorCode | int | - | Код ошибки | 0 |
| ErrorCodeDescription | str    | - | Описание ошибки устройства по данным драйвера | "OK" |
| DriverMode | int | - | Режим по данным драйвера | 0 |
| DriverModeDescription | str    | - | Описание режима Mode по данным драйвера | "" |
| DriverAdvancedMode | int | - | Специальный режим по данным драйвера | 0 |
| DriverAdvancedModeDescription | str    | - | Описание режима AdvancedMode по данным драйвера | 0 |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| ShiftNumber | float  | - | Номер смены | 40.0 |
...
| deviceName | str    | + | Имя устройства | "Atol" |
| docId | str    | + | Идентификатор документа открытия смены. Передайте в [GET shift/open](#getopenshift), чтобы получить результат открытия смены. | "31f9d8a2-6424-4085-807c-a349d51884b1" |
| fnsUrl | str    | - | Адрес сайта уполномоченного органа (ФНС) в сети «Интернет» | "nalog.ru" |
| fnNumber | str    | - | Номер фискального накопителя | "0123123123123" |
| rnNumber | str    | - | Регистрационный номер ККт | "00031415926" |
| fiscalDatetime | str    | - | Дата и время документа по часам ФН | "20260523234515" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- |
| Result | str    | + | Идентификатор документа открытия смены. Передайте в [GET shift/open](#getopenshift), чтобы получить результат открытия смены. | "321581c0-2ebe-4f4e-bdf8-a932ad758dac" |
...
| datetime | datetime | - | Время операции | "2026-05-12T18:38:52" |
| deviceName | str    | + | Имя устройства | "Atol" |
| docId | str    | + | Идентификатор документа Z-отчёта. Передайте в [GET shift/z](#getreportz), чтобы получить Z-отчёт. | "31f9d8a2-6424-4085-807c-a349d51884b1" |
| fnsUrl | str    | - | Адрес сайта уполномоченного органа (ФНС) в сети «Интернет» | "nalog.ru" |
| fnNumber | str    | - | Номер фискального накопителя | "0123123123123" |
| rnNumber | str    | - | РНМ | "00031415926" |
| fiscalDatetime | str    | - | Дата и время документа по часам ФН | "20260523234515" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | + | Идентификатор документа Z-отчёта. Передайте в [GET shift/z](#getreportz), чтобы получить Z-отчёт. | "321581c0-2ebe-4f4e-bdf8-a932ad758dac" |
...
| datetime | datetime | - | Время операции | "2026-05-12T18:38:52" |
| deviceName | str    | + | Имя устройства | "Atol" |
| docId | str    | + | Идентификатор документа  X-отчёта. Передайте в [GET shift/x](#getreportx), чтобы получить X-отчёт. | "4b161ba3-bb5f-4209-964b-3c3f0e6f43b8" |
| fnsUrl | str    | - | Адрес сайта уполномоченного органа (ФНС) в сети «Интернет» | "nalog.ru" |
| fnNumber | str    | - | Номер фискального накопителя | "0123123123123" |
| rnNumber | str    | - | РНМ | "00031415926" |
| fiscalDatetime | str    | - | Дата и время документа по часам ФН | "20260523234515" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | - | Идентификатор документа X-отчёта. Передайте в [GET shift/x](#getreportx), чтобы получить X-отчёт. | "321581c0-2ebe-4f4e-bdf8-a932ad758dac" |
...
| datetime | datetime | - | Время операции | "2026-05-12T18:38:52" |
| deviceName | str    | + | Имя устройства | "Atol" |
| docId | str    | + | Идентификатор документа отчёта о текущем состоянии расчётов. Передайте в [GET report/settlement](#getreportsettlement), чтобы получить отчёт о состоянии расчётов. | "d4caa283-0438-4bff-8ccf-2d77a5014d7d" |
| fnsUrl | str    | - | Адрес сайта уполномоченного органа (ФНС) в сети «Интернет» | "nalog.ru" |
| fnNumber | str    | - | Номер фискального накопителя | "0123123123123" |
| rnNumber | str    | - | РНМ | "00031415926" |
| fiscalDatetime | str    | - | Дата и время документа по часам ФН | "20260523234515" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | + | Идентификатор документа отчёта о текущем состоянии расчётов. Передайте в [GET report/settlement](#getreportsettlement), чтобы получить отчёт о состоянии расчётов. | "321581c0-2ebe-4f4e-bdf8-a932ad758dac" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа открытия смены | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| FiscalSign | str    | - | Фискальный признак документа | "5847203916" |
| Fn | str    | - | Серийный номер фискального накопителя | "0123123123123" |
| FiscalDate | datetime | - | Время регистрации операции по часам ККМ. | "2026-05-24T00:11:23.5505769+08:00" |
| CashierName | str    | - | Имя кассира | "Иванов А.И." |
| CashierVatin | str    | - | ИНН кассира | "7722345678" |
| SaleAddress | str    | - | Адрес проведения расчетов | "г.Улан-Удэ, ул.Виноградная, д11А, офис 25" |
| SaleLocation | str    | - | Место проведения расчетов | "Офис" |
| FfdVersion | str    | - | Версия ФФД | "1.2" |
| Tlv | str    | - | Cтруктура значений тегов документа | "" |
...
| DocId | str    | + | Идентификатор документа | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| ResultDescription | str    | - | Описания результата | "OK" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа X-отчёта | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| DocNumber | int | - | Номер фискального документа | 5 |
| DocNumberInShift | int | - | Номер фискального документа за смену | 1 |
| FiscalSign | str    | - | Фискальный признак документа | "4988644533" |
| Fn | str    | - | Серийный номер фискального накопителя | "0123123123123" |
| FiscalDate | datetime | - | Время регистрации операции по часам ККМ. | "2026-05-24T00:11:23.5505769+08:00" |
| CashierName | str    | - | Имя кассира | "Иванов А.И." |
| CashierVatin | str    | - | ИНН кассира | "7722345678" |
...
| FfdVersion | str    | - | Версия ФФД | "1.2" |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 11 |
| DocId | str    | + |  Идентификатор документа X-отчёта | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | Пул, который назначен чеку | "" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор операции Z-отчёта | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| After |  -  | Список типа данных | Подвал | \[\] |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 11 |
| DocId | str    | + | Идентификатор документа Z-отчёта | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа отчёта о текущем состоянии расчётов | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| FfdVersion | str    | - | Версия ФФД | "1.2" |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 11 |
| DocId | str    | + | Идентификатор документа отчёта о текущем состоянии расчётов | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | + | Пул, который назначен чеку | "" |
...
| SenderEmail           | str                 | –        | Адрес электронной почты отправителя чека. <br><br>Если поле не указано или пустое, адрес отправителя не используется. | "ivanov@mail.ru" |
| SaleAddress           | str                 | –        | Адрес проведения расчётов. <br><br>Если поле не указано, используется адрес из настроек ККТ. <br><br>Если в настройках ККТ, во вкладке "Автоматические действия" выставлен флаг "Заменять принудительно", значение из запроса всегда заменяется адресом из вкладки «Автозамена».  | "г.Улан-Удэ, ул.Виноградная, д11А, офис 25" |
| SaleLocation          | str                 | –        | Место проведения расчётов. <br><br>Если поле не указано, используется значение из настроек ККТ. <br><br>Если в настройках ККТ, во вкладке "Автозамена" задано "Место расчётов" и в чеке поле пустое — используется значение из вкладки "Автозамена".  <br>  <br>Если в настройках ККТ, во вкладке "Автозамена" выставлен флаг "Заменять принудительно", значение из запроса заменяется значением из настроек ККТ.<br><br>Если также включена опция «Признак расчёта в интернете», драйвер позволяет вместо адреса указать ссылку на сайт в этом поле (тег 1187). | "Офис" |
...
| AdditionalAttribute   | str                 | –        | Дополнительный реквизит чека (тег 1192). <br><br>Если поле не указано или пустое, реквизит не передаётся. <br><br>Рекомендуется указывать здесь ФП корректируемого чека при оформлении возврата или коррекции.  | `"6702704322"` |
...
| deviceName     | str      | + | Название устройства | "Atol"  |
| docId          | str      | + | Идентификатор документа чека. Передайте в GET-запрос, чтобы получить результат операции | "4bdcaa12-15a3-470c-b07d-3a498242193a" |
| fnsUrl         | str      | - | Адрес сайта уполномоченного органа (ФНС) в сети «Интернет» | "nalog.ru"  |
| fnNumber       | str      | - | Номер фискального накопителя  | "0123123123123"  |
| rnNumber       | str      | - | Регистрационный номер ККТ | "00031415926" |
| fiscalDatetime | str      | - | Дата и время документа по часам ФН  | "20260525120147" |
| fiscalSign | str    | - | Фискальный признак документа| "5847203916" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | + | Идентификатор документа чека. Передайте в GET-запрос, чтобы получить результат операции | "31f9d8a2-6424-4085-807c-a349d51884b1" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа чека | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| CheckItems | list[[CheckItem](#checkitem)] | - | Позиции чека | "CheckItems": [ <br>  {<br>"Name": "Бутылка с водой 1л.", <br>"Quantity": 1, <br>"Price": 50, <br>"Department": 0, <br>"Sum": 50, <br>"IsFiscal": true, <br>"TaxValue": 20, <br>"PaymentMode": 3, <br>"ItemType": 10, <br>"ExciseAmount": 0, <br>"MeasureOfQuantity": 20 <br>} <br>], |
...
| ClientContact | str    | - | Номер телефона или электронная почта клиента | "kuznicov@mail.ru" |
...
| SaleLocation | str    | - | Место проведения расчетов | "Офис" |
| FfdVersion | str    | - | Версия ФФД | "1.2" |
| Tlv | str    | - | Cтруктура значений тегов документа | "1209,Номер версии ФФД:4\\r\\n1041,Номер ФН:999907890..." |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 11 |
| DocId | str    | + | Идентификатор документа чека. Передайте в GET-запрос, чтобы получить результат операции | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocId | str    | + | Идентификатор документа, для которого необходимо выполнить повторную печать. <br><br>По указанному идентификатору сервер выполняет поиск чека во внутренней базе данных. Если чек найден, на ККМ отправляется задание на печать его копии. <br>Если документ с указанным идентификатором не найден, запрос завершается ошибкой. |
| DeviceName | str    | + | Имя устройства. Если имя не указано, будет использована касса, указанная в чеке. <br>Если эта касса недоступна, будет выбрана первая свободная. | "Atol" |
...
| --- | --- | --- | --- | --- |
| DeviceName | str    | + | Имя устройства. | Atol |
| CheckNumber | str    | + | Номер фискального документа. | 8 |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | - | Фискальный признак | "1807094707" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа (docId) из ответа POST-запроса. | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| --- | --- | --- | --- | --- |
| DeviceName | str    | + | Имя устройства | "Atol" |
| DocId | str    | + | Идентификатор документа | "855fa6cb-5e05-4983-8e39-de5187ac7a21" |
...
| PoolId | str    | - | Идентификатор пула, в рамках которого обрабатывалось задание. Если устройство не входит в пул — не заполняется. | "pool" |
...
| FiscalSign | str    | - | Фискальный признак. Фискальный признак документа. Заполняется только для фискальных документов | "1173363965" |
| ResultCode | int | - | Код результата обработки задания | 0 |
| ResultDescription | str    | - | Описание результата обработки задания | "OK" |
...
| Line | str    | - | Текст строки (левая часть) | "Кассовый чек" |
| LineRight | str    | - | Текст строки (правая часть) | "ЧЕК 2" |
...
| BarcodeLines | list[str] | - | Массив строк, выводимые спрва или слева от штрихакодв | "ЗН ККТ: 0020260207",  <br>"РН ККТ: 00031415926",  <br>"ИНН 7722345678",  <br>"ФН: 0123123123123",  <br>"ФД: 343",  <br>"ФП: 1352614355",  <br>"ПРИХОД",  <br>"22.05.26 15:06",  <br>"Сайт ФНС:  <br>[nalog.ru"](http://www.nalog.gov.ru) |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | + | Идентификатор документа чека коррекции ФФД 1.2. Передайте в [GET correction120](#getcorrection120), чтобы получить чек коррекции ФФД 1.2. | "cbac9c78-c4f5-4f03-8be9-696136ebc9ab" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- |
| Result | str    | + | Идентификатор документа чека коррекции ФФД 1.0.5. Передайте в [GET correction105](#getcorrection105), чтобы получить чек коррекции. | "cbac9c78-c4f5-4f03-8be9-696136ebc9ab" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа чека коррекции ФФД 1.2 | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| CheckItems | list[[CheckItem](#checkitem)] | - | Позиции чека | "CheckItems": [], |
| Electronically | bool | - | Регистрация чека без печати на ленте | false |
...
| CustomerDetail | [CustomerDetail](#customerdetail) | - | Cведения о покупателе (клиенте) | "CustomerDetail": {<br>"Info": "ООО 'Рога и Копыта'", <br>"Vatin": "500100732259", <br>"Email": "kuznicov@mail.ru" <br>}, |
| QrData | [QrCheckData](#qrcheckdata) | - | Данные для отображения QR кода чека | "QrData": { <br>"Date": "2026-05-24T12:52:00+08:00", <br>"Amount": 50, <br>"Fn": "9999078902010507", <br>"Fd": 370, <br>"Fp": "2928907410",<br>"N": 1 <br>}, |
| DocId | str    | + | Идентификатор документа чека коррекции ФФД 1.2 | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа чека коррекции ФФД 1.0.5 | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| TaxSum122 | Decimal | - | Сумма НДС 122 | 0.0 |
| TaxSum22 | Decimal | - | Сумма НДС 22 | 0.0 |
| AdditionalAttribute      | str          | - | Дополнительный реквизит чека (БСО, тег 1192)| "6702704322" |
| ShiftNumber | int | + | Номер сессии | 3 |
| CashierName | str    | - | Имя кассира | "Иванов А.И." |
| CashierVatin | str    | - | ИНН кассира | "7722345678" |
| DocumentHeader | [DocumentHeader](#documentheader) | - | Заголовок документа | "DocumentHeader": {<br>"OrganizationInfo": "ООО 'Ромашка'",<br>"SerialNumber": "00109325182732",<br>"Vatin": "7722345678",<br>"Cashier": "Иванов А.И.",<br>"RnNumber": "0000000001002520",<br>"Fn": "9999078902012910",<br>"FnsUrl": "nalog.ru",<br>"ShiftNumber": 3,<br>"CheckNumber": 20,<br>"OfdOrganizationName": "Тестовый ОФД",<br>"OfdVatin": "7709364346"<br>} |
...
| Tlv | str    | - | Cтруктура значений тегов документа | "1209,Номер версии ФФД:4\\r\\n1041,Номер ФН:999907890..." |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 11 |
| DocId | str    | + |Идентификатор документа чека коррекции ФФД 1.0.5 | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| FfdVersion | str    | - | Версия ФФД | "1.2" |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 11 |
| DocId | str    | + | Идентификатор операции внесения наличных. Передайте в [GET cashin](#getcashin), чтобы получить результат внесения наличных. | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | + | Идентификатор документа операции внесения наличных. Данный идентфикатор можно использовать для [GET cashin](#getcashin), чтобы получить более подробную информацию. | "788eeda8-c2aa-4b51-8f39-db93d8e79b91" |
...
| FfdVersion | str    | - | Версия ФФД | "1.2" |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 11 |
| DocId | str    | + | Идентификатор операции выемки наличных. Передайте в [GET cashout](#getcashout), чтобы получить результат выемки наличных. | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | + | Идентификатор документа операции выемки наличных. Данный идентфикатор можно использовать для [GET cashout](#getcashout), чтобы получить более подробную информацию. | "788eeda8-c2aa-4b51-8f39-db93d8e79b91" |
...
| FfdVersion | str    | - | Версия ФФД | "1.2" |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 11 |
| DocId | str    | + | Идентификатор документа открытия смены | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор операции внесения наличных | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор операции выемки наличных | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| ------------ | ------------- | -------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DeviceName   | str           | +        | Название устройства | "Atol"                                                                                                                                                                                                                                                                                                                       |
| Positions    | list[DocPosition] | +        | Элементы документа  | "Positions": [<br>{<br>"TextString": {<br>"Text": "[big]Мой дядя, самых честных правил,"<br>}<br>},<br>{<br>"TextString": {<br>"Text": "[dotted]"<br>}<br>},<br>{<br>"TextString": {<br>"Text": "Он уважать себя заставил,"<br>}<br>},<br>{<br>"Barcode": {<br>"Type": "EAN13",<br>"Barcode": "1235467890126"<br>}<br>}<br>] |
...
| DocId | str    | + | Идентификатор нефискального документа. Передайте в [GET slip](#getslip), чтобы получить результат. | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | + | Идентификатор нефискального документа. Передайте в [GET slip](#getslip), чтобы получить результат. | "94cc354c-2dd3-4231-ac50-aa3a62883efe" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор нефискального документа | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| DocNumber | int | - | Номер фискального документа | 0 |
| DocNumberInShift | int | - | Номер фискального документа за смену | 0 |
| Fn | str    | - | Серийный номер фискального накопителя | "" |
| FiscalDate | datetime | - | Время регистрации операции по часам ККМ. | "0001-01-01T00:00:00" |
| CashierName | str    | - | Имя кассира | Иванов А.И. |
| CashierVatin | str    | - | ИНН кассира | 7722345678 |
| DocumentHeader | [DocumentHeader](#documentheader) | - | Заголовок документа | "DocumentHeader": {<br>"OrganizationInfo": "ООО 'Ромашка'",<br>"SerialNumber": "00109325182732",<br>"Vatin": "7722345678",<br>"Cashier": "Иванов А.И.",<br>"RnNumber": "0000000001002520",<br>"Fn": "9999078902012910",<br>"FnsUrl": "nalog.ru",<br>"ShiftNumber": 3,<br>"CheckNumber": 20,<br>"OfdOrganizationName": "Тестовый ОФД",<br>"OfdVatin": "7709364346"<br>} |
| DocId | str    | + | Идентификатор нефискального документа. | "94cc354c-2dd3-4231-ac50-aa3a62883efe" |
| TaskType | int | - | Тип чека: <br>0 — Текст  <br>1 — Приход  <br>2 — Возврат прихода  <br>3 — Расход  <br>4 — Возврат расхода  <br>5 — Коррекция прихода  <br>6 — Коррекция возврата прихода  <br>7 — Коррекция расхода  <br>8 — Коррекция возврата расхода  <br>9 — Слип  <br>10 — Фискализация  <br>11 — Открытие смены  <br>12 — Z-отчет  <br>13 — X-отчет  <br>14 — Отчет о состоянии расчетов  <br>20 — Выемка  <br>21 — Внесение  <br>22 — Открытие денежного ящика | 9 |
|
| Lines | list[[PrintLine](#printline)] | - | Строки печати | "Lines": [<br>{<br>"Type": 1,<br>"Width": 0,<br>"Scale": 100,<br>"Line": "Мой дядя, самых честных правил,",<br>"LineRight": "",<br>"Alignment": 0,<br>"Font": 0,<br>"Wrap": true,<br>"IsCreateFromTemplate": false<br>},<br>{<br>"Type": 1,<br>"Width": 0,<br>"Scale": 100,<br>"Line": "Он уважать себя заставил,",<br>"LineRight": "",<br>"Alignment": 0,<br>"Font": 0,<br>"Wrap": true,<br>"IsCreateFromTemplate": false<br>},<br>{<br>"Type": 2,<br>"Width": 0,<br>"Scale": 100,<br>"Line": "",<br>"LineRight": "",<br>"Alignment": 1,<br>"Font": 0,<br>"Wrap": true,<br>"Barcode": {<br>"Type": "EAN13",<br>"Value": "1235467890126",<br>"PictureBase64": "iVBORw0KGgoAAAANSUhEUgAAAHEAAAB",<br>"PrintText": 1,<br>"Height": 100,<br>"BarWidth": 2<br>},<br>"IsCreateFromTemplate": false<br>}<br>] |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которго пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Emu" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
| ResultCode | int | - | Результат | 0 |
| ResultDescription | str    | - | Описания результата | "OK" |
| Processed | bool | - | Признак удачного завершения обработки | true |
...
| --- | --- | --- | --- | --- |
| DeviceName | str    | + | Имя устройства | "Atol" |
| Base64 | str    | + | Изображение закодированное в Base64 | "iVBORw0KGgoAAAANSUhEUgA..." |
| PictureName | str    | + | Название изображения — используется как идентификатор при последующем получении или удалении. | "logo" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Имя изображение. | name32 |
| DeviceName | str    | + | Имя устройства. | Atol |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Picture | str    | - | Изображение в кодировке Base64 | "iVBORw0KGgoAAAANSUhEUg..." |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| PictureBase64 | str    | + | Изображение в формате base64 | "iVBORw0KGgoAAAANSU..." |
| PictureName | str    | + | Название изображения | "name" |
...
| --- | --- | --- | --- | --- |
| DeviceName | str    | + | Имя устройства. | Atol |
| DocumentId | str    | + | Имя изображение | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | - | Название шаблона. Данное значение можно использовать для GET или [DELETE template](#deletetemplate), чтобы получить более подробную информацию или удалить созданный печатный шаблон. | "name7" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Название печатного шаблона | base_header |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | list[str] | - | Массив с названиями шаблонов | "base_advertisement",  <br>"base_check_lines",  <br>"base_header",  <br>"name3",  <br>"name7",  <br>"test" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| name | str    | + | Название шаблона. | base_header |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Name | str    | + | Уникальное имя шаблона. | "base_header" |
| TemplateItems | list[[AdvItem](#advitem)] | + | Строки шаблона (только нефискальные поля) | "TemplateItems": [<br>{<br>  "PrintLine": {<br>"Type": 1,<br>"Line": "Текст",<br>"LineRight": "",<br>"Alignment": 1,<br>"Font": 5,<br>"Wrap": true<br>}<br>},<br>{<br>"PrintLine": {<br>"Type": 1,<br>"Line": "Сумма",<br>"LineRight": "1 250,00",<br>"Alignment": 0,<br>"Font": 0,<br>"Wrap": false<br>}<br>},<br>{<br>"PrintLine": {<br>"Type": 4,<br>"SeparatorLine": {<br>"LineStyle": 0<br>}<br>}<br>},<br>{<br>"PrintLine": {<br>"Type": 2,<br>"Alignment": 1,<br>"Barcode": {<br>"Type": "QR",<br>"Value": "https://www.rbsoft.ru/",<br>"PrintText": 0,<br>"Height": 30,<br>"BarWidth": 6<br>}<br>}<br>},<br>{<br>"PrintLine": {<br>"Type": 3,<br>"Alignment": 1,<br>"Scale": 100,<br>"Picture": {<br>"PictureBase64": "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8z8BQDwAEhQGAhKmMIQAAAABJRU5ErkJggg==",<br>"Alignment": 2,<br>"Width": 200,<br>"Height": 80<br>}<br>}<br>}<br>] |
| Type | int | - | Тип шаблона: <br>0 — Реклама;  <br>1 — Строки чека;  <br>2 — Шапка или подвал чека | 1 |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Name | str    | + | Уникальное имя шаблона чека. Допустимы только символы "a-zA-Z0-9_-()", пробелы запрещены. | "sale_template_01" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Название шаблона чека | piot_test_classic_5.1 |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Name | str    | + | Уникальное имя шаблона чека. | "piot_test_classic_5.1" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Имя шаблона чека | piot_test_classic_5.1 |
...
| Description | str    | - |Описание результата | "Ok" |
...
| Description | str    | - | Описание | "Ошибок нет" |
...
| --- | --- | --- | --- | --- |
| DeviceName | str    | + | Имя устройства | "Atol" |
| GUID | str    | + | Код запроса. Его ранее передавали в marking/km/request. | "46dc63e5-8efa-4da6-b8ee-d6188da7b26a" |
...
| --- | --- | --- | --- | --- |
| DeviceName | str    | + | Название устройства | "Atol" |
| Codes | list[str] | + | Массив проверяемых кодов маркировки в кодировке Base64. | ["MDEwNDY3MDU0MDE3NjA5OTIxNSdXOVVtHTkzZEdWeg=="] |
...
| description    | str    | - | Описание результата | "OK" |
| reqId | str    | + | Идентификатор запроса в сервисе «Честного Знака» | "a1b2c3d4-e5f6-7890-abcd-ef1234567890" |
| reqTimestamp | int  | - | Время выполнения проверки КМ (Unix-время в миллисекундах) | 1781076703146 |
...
| lastUpdate | int  | - | Время последнего обновления локальной базы данных модуля. <br>0 — нет данных / не актуально. | 0 |
| lastSync | int  | - | Время последней синхронизации модуля с ГИС МТ. <br>0 — нет данных. | 0 |
| codes | list[[CodeMarkInfo](#codemarkinfo)] | + | Данные проверки кода маркировки. | "codes": [<br>{<br>"Cis": "0104670540176099215'W9Um93dGVz",<br>"valid": true,<br>"verified": true,<br>"realizable": true,<br>"utilised": true,<br>"found": true,<br>"sold": true,<br>"isBlocked": true,<br>"isGreyGtin": true,<br>"gtin": "04670540176099",<br>"groupIds": [8]<br>}<br>] |
...
| description               | str                     | - | Описание результата                                                                                                            | "OK"         |
| reqId                     | str                     | + | Идентификатор запроса                                                                                                          | "b0bbb45a-e773-8b63-32e6-da06f1002466" |
| reqTimestamp              | int                     | - | Время выполнения проверки кода маркировки (Unix-время в миллисекундах)                                                          | 1781077845362 |
...
| lastUpdate                | int                     | - | Время последнего обновления локальной базы данных модуля. 0 — данных нет или неактуально.                                       | 0            |
| lastSync                  | int                     | - | Время последней синхронизации модуля с ГИС МТ. 0 — данных нет.                                                                  | 0            |
| version                   | str                     | - | Версия локального модуля                                                                                                       | "019e978f-e682-7b78-8127-e7cf95b63586" |
| inst                      | str                     | - | Идентификатор экземпляра локального модуля ЧЗ                                                                                   | "019eb008-c2d2-7889-b91a-a3455dc42384" |
| serviceUrl                | str                     | - | Адрес локального модуля ЧЗ, к которому фактически было выполнено обращение | "127.0.0.1:5995" |
| codes | list[[CodeMarkInfo](#codemarkinfo)] | + | Данные проверки кода маркировки | "codes": [<br>{<br>"cis": "0104670540176099215'W9Um",<br>"valid": false,<br>"verified": false,<br>"realizable": false,<br>"utilised": false,<br>"isTracking": false,<br>"sold": false,<br>"gtin": "04670540176099",<br>"grayZone": false,<br>"isBlocked": false,<br>"isGreyGtin": false,<br>"found": false,<br>"packageQuantity": 0<br>}<br>] |
...
| OfdName | str    | - | Название ОФД | "Тестовый ОФД" |
| OfdVatin | str    | - | ИНН ОФД | "1234554321" |
| FnsUrl | str    | - | Адрес сайта ФНС | "nalog.ru" |
| SenderEmail | str    | - | Email отправителя чека | "ivanov@mail.ru" |
...
| AgentTypes | str    | - | Коды признаков агента через разделитель ",". <br> 0 — Банковский платежный агент;<br> 1 — Банковский платежный субагент;<br> 2 — Платежный агент;<br> 3 — Платежный субагент;<br> 4— Поверенный;<br> 5 — Комиссионер;<br> 6 — Агент;<br> | "1,2,4" |
...
| RnNumber | str    | - | Регистрационный номер ККТ | "0000000000047797" |
...
| FnsUrl | str    | - | Адрес сайта ФНС | "[nalog.ru"](http://www.nalog.gov.ru) |
| OfdVatin | str    | - | ИНН ОФД | "1234554321" |
| OfdName | str    | - | Название ОФД | "Тестовый ОФД" |
...
| TaxationSystems | str    | - | Коды системы налогообложения | "0,1,2,4,5", |
| Vatin | str    | - | ИНН организация | "7722345678", |
| CompanyName | str    | - | Название организации | "ООО 'Ромашка'", |
| FfdVersionKkt | str    | - | Версия ФФД ККТ | "1.2" |
| FfdVersionFn | str    | - | Версия ФФД ФН | "1.2 |
| IsSupportFnPiot | bool | - | ККТ поддерживает работу с ТС ПИоТ | false, |
| IsFiscal | bool | - | Фискальный режим | true |
| SerialNumber | str    | - | Заводской номер ККТ | "0020260207", |
| RegistrationLabelCodes | str    | - | Коды причин изменения сведений о ККТ | "3.1", |
...
| DocId | str    | + | Идентификатор документа фискализации. Передайте в [GET fiscalization](#getfiscalization), чтобы получить результат | "7ccfb3d4-bc93-40c7-9e4d-aa1c8b0261b6" |
| Date | datetime | - | Дата создания документа | "2026-05-24T00:11:23.5221437+08:00" |
| TerminalId | str    | - | Идентификатор терминала, с которого пришел документ | "" |
| DeviceName | str    | + | Имя устройства | "Atol" |
| PoolId | str    | - | Пул, который назначен чеку | "" |
| ResultCode | int | - | Результат | 0 |
| ResultDescription | str    | - | Описания результата | "OK" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Result | str    | - | Идентификатор документа фискализации. Передайте в [GET fiscalization](#getfiscalization)`, чтобы получить результат | "802e6783-6c95-42a2-b583-b99d6ca1b151" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа фискализации | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocId              | str          | + | Идентификатор документа задания. |
| DeviceName         | str          | + | Название устройства, которому адресовано задание | "Atol"  |
| PoolId | str          | - | Идентификатор пула, если задание адресовано пулу устройств, а не конкретному устройству | "" |
...
| ErrorDescription   | str    | - | Текстовое описание текущего состояния или ошибки задания | "Постановка в очередь печати" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| taskId | str    | + | Идентификатор документа (docId), полученный в ответе на POST-запрос. По нему задание отслеживается в очереди. | b0ce9370-4435-49f8-a5e8-9bc267a26f77 |
...
| --- | --- | --- | --- | --- |
| DeviceName               | str          | + | Название устройства                                                                                                                                        | "Atol"                                     |
| DocId                    | str            | + | Идентификатор документа. Данный идентификатор можно использовать для [GET queue/task/history](#getqueuetaskhistory), чтобы узнать историю обработки документа                                                                                                                                    | "53edb056-1bc0-458d-84d1-46e0cea211c1"    |
...
| ResultDescription        | str          | - | Описание результата                                                                                                                                         | "OK"                                        |
| Date                     | datetime     | - | Дата и время последнего изменения статуса задачи                                                                                                            | "2026-05-21T16:57:34"                     |
| FiscalSign               | str          | - | Фискальный признак документа. Заполняется только для успешно обработанных фискальных заданий.                                                               | "3327337010"                                |
| DocumentHeader           | [DocumentHeader](#documentheader)   | - | Заголовок документа. | "DocumentHeader": {<br>"OrganizationInfo": "ООО 'Ромашка'",<br>"SerialNumber": "0020260207",<br>"Vatin": "7722345678",<br>"Cashier": "Иванов А.И.",<br>"RnNumber": "00031415926",<br>"Fn": "0123123123123",<br>"FnsUrl": "nalog.ru",<br>"ShiftNumber": 39,<br>"DocNumber": 336,<br>"FiscalSign": "3327337010",<br>"OfdOrganizationName": "Тестовый ОФД",<br>"OfdVatin": "1234554321"<br>} |
| PrintStatusDescription   | str      | - | Описание текущего этапа обработки задания | "Чек успешно напечатан" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| History | list[[DocumentHistory](#documenthistory)] | - | Хронология событий обработки задачи, от самого раннего к самому позднему |"History": [<br>{<br>"Time": "2026-05-21T16:57:25",<br>"State": 4,<br>"Description": "Добавление в очередь",<br>"Info": ""<br>},<br>{<br>"Time": "2026-05-21T16:57:34",<br>"State": 0,<br>"Description": "Начало выполнения",<br>"Info": ""<br>},<br>{<br>"Time": "2026-05-21T16:57:44",<br>"State": 1,<br>"Description": "Успешное завершение",<br>"Info": ""<br>}<br>] |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocId | str    | + |  Идентификатор документа | "593ab0d0-1fdd-4b11-85af-0e6c2f09284c" |
...
| ResultDescription | str    | - | Описание результата | "Документ удален из очереди" |
...
| **Имя поля**        | **Тип**                             | **Обяз** | **Назначение**                                                                                                                                                                                                                                                                                                                                                                              | **Пример**                                              |
| ------------------- | ----------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| CheckItems          | list[[CheckItem](#checkitem)]     | -        | Позиции документа (для чеков)                                                                                                                                                                                                                                                                                                                                                               | [{"Name": "Кофе американо", "Sum": 150.0, …}]           |
...
| FiscalSign          | str                                 | -        | Фискальный признак                                                                                                                                                                                                                                                                                                                                                                          | "8924647256"                                            |
| Fn                  | str                                 | -        | Номер фискального накопителя                                                                                                                                                                                                                                                                                                                                                                | "0123123123123"                                         |
...
| SaleAddress         | str                                 | -        | Адрес расчётов                                                                                                                                                                                                                                                                                                                                                                              | "г.Улан-Удэ, ул.Балтахинова, д17Е"                      |
| SaleLocation        | str                                 | -        | Место расчётов                                                                                                                                                                                                                                                                                                                                                                              | "Офис"                                                  |
| FfdVersion          | str                                 | -        | Версия ФФД документа                                                                                                                                                                                                                                                                                                                                                                        | "1.2"                                                   |
| Tlv                 | str                                 | -        | TLV-представление документа                                                                                                                                                                                                                                                                                                                                                                 | ""                                                      |
| TaskType            | int                                 | -        | Тип задания:  <br>1 — Приход;  <br>2 — Возврат прихода;  <br>3 — Расход;  <br>4 — Возврат расхода;  <br>5 — Коррекция прихода;  <br>6 — Коррекция возврата прихода; <br>7 — Коррекция расхода;  <br>8 — Коррекция возврата расхода;  <br>9 — Слип;  <br>11 — Открытие смены;  <br>12 — Z-отчёт;  <br>13 — X-отчёт;  <br>14 — Отчёт о состоянии расчётов;  <br>22 — Открытие денежного ящика | 1                                                       |
| DocId               | str                                 | -        | Идентификатор документа                                                                                                                                                                                                                                                                                                                                                                     | "567e2bde-9fb2-4fde-bac4-ceb6aed54bb4"                  |
| Date                | datetime                            | -        | Дата операции                                                                                                                                                                                                                                                                                                                                                                               | "2026-08-31T14:49:55+08:00"                             |
| TerminalId          | str                                 | -        | Идентификатор терминала                                                                                                                                                                                                                                                                                                                                                                     | ""                                                      |
| DeviceName          | str                                 | -        | Имя устройства                                                                                                                                                                                                                                                                                                                                                                              | "Emu"                                                   |
| PoolId              | str                                 | -        | Идентификатор пула                                                                                                                                                                                                                                                                                                                                                                          | ""                                                      |
| ResultCode          | int                                 | -        | Код результата (`0` — успех)                                                                                                                                                                                                                                                                                                                                                                | 0                                                       |
| ResultDescription   | str                                 | -        | Описание результата                                                                                                                                                                                                                                                                                                                                                                         | "OK"                                                    |
| Processed           | bool                                | -        | Операция обработана                                                                                                                                                                                                                                                                                                                                                                         | true                                                    |
| ServerVersion       | str                                 | -        | Версия сервера                                                                                                                                                                                                                                                                                                                                                                              | "4.0.70.827"                                            |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение**          | **Пример**                             |
| ----------------- | ------- | -------- | ----------------------- | -------------------------------------- |
| DocumentId        | str     | +        | Идентификатор документа | "8f733118-76ce-4c92-8678-760bb72d3f62" |
...
| Description  | str                         | -        | Описание события                 | "Добавление в очередь"   |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | Идентификатор документа (параметр `docId`) | "8f733118-76ce-4c92-8678-760bb72d3f62" |

**Тело ответа**

| **Имя поля** | **Тип** | **Обяз** | **Назначение**              | **Пример**                                                                            |
| ------------ | ------- | -------- | --------------------------- | ------------------------------------------------------------------------------------- |
| Result       | str     | +        | TLV-представление документа | "1209,Номер версии ФФД:4\r\n1041,Номер ФН:9999078902010507\r\n1040,Номер ФД:342\r\n…" |
...
| **Имя поля**         | **Тип**  | **Обяз** | **Назначение**            | **Пример**                                            |
| -------------------- | -------- | -------- | ------------------------- | ----------------------------------------------------- |
| Cis                  | str      | -        | Код маркировки (КиЗ)      | "0104607058926809215fY9s<"                            |
| CheckedAt            | datetime | -        | Время проверки            | "2026-08-21T17:52:42"                                 |
| PrintView            | str      | -        | Представление для печати  | "0104607058926809215fY9s<"                            |
| Message              | str      | -        | Сообщение проверки        | "Марка не найдена: [0104…] Код маркировки не найден." |
| CheckStatus          | int      | -        | Статус проверки           | 0                                                     |
| PositionName         | str      | -        | Наименование позиции      | "Бутылка с водой 1л."                                 |
| DocIds               | list[str] | -        | Идентификаторы документов | ["ba78057f-…", "c5c0cef7-…"]                          |
| SalePrice            | int      | -        | Цена продажи (в копейках) | 75000                                                 |
| DeviceName           | str      | +        | Имя устройства            | "Emu"                                                 |
| MarkId               | str      | -        | Идентификатор марки       | "aa07b239-3541-460c-8000-71614dd2ebca"                |
...
| **Имя поля**     | **Тип**  | **Обяз** | **Назначение**                                    | **Пример**                             |
| ---------------- | -------- | -------- | ------------------------------------------------- | -------------------------------------- |
| DocId            | str      | +        | Идентификатор документа                           | "56e92dac-8e07-4934-9dfa-7060400888d0" |
| BaseDocId        | str      | +        | Идентификатор базового документа                  | "383f6fd3-7ec6-4ccb-9608-4426fa2439b5" |
| RequestId        | str      | -        | Идентификатор запроса                             | ""                                     |
| TerminalId       | str      | -        | Идентификатор терминала                           | ""                                     |
| DeviceName       | str      | +        | Имя устройства                                    | "Emu"                                  |
| PoolId           | str      | -        | Идентификатор пула                                | ""                                     |
...
| TaskName         | str      | -        | Название задания                                  | "Слип"                                 |
...
| FiscalSign       | str      | -        | Фискальный признак                                | "4118171897"                           |
| Fn               | str      | -        | Номер фискального накопителя                      | "0123123123123"                        |
| ClientContact    | str      | -        | Контакт покупателя                                | ""                                     |
| CashierName      | str      | -        | Кассир                                            | "Иванов А.И."                          |
| RnKKT            | str      | -        | Регистрационный номер ККТ                         | "00031415926"                          |
| ZnKKT            | str      | -        | Заводской номер ККТ                               | "0020260207"                           |
...
| ServiceTimeOut | timedelta | - | Таймаут обработки запросов. <br><br>Если значение не удаётся прочитать из настроек сервера, возвращается `"00:00:00"`, без явной пометки ошибки.  | "00:00:15" |
...
| ServiceTimeOut | str    | \- | Таймаут обработки запросов (hh:mm:ss). <br><br>Если поле не передано, будет сохранено значение `"00:00:00"` | "00:00:15" |
| ProxyServerSettings | [ProxyConfig](#proxyconfig) | - | Конфигурация прокси сервера | "ProxyServerSettings": {<br>"IsUseProxy": false,<br>"IpAddress": "",<br>"Port": 0,<br>"Name": "",<br>"Password": ""<br>} |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| tokenId | str    | + | Токен авторизации | "7aa6f555-69bb-41d9-b4aa-6b4d7e7e779e" |
| expire | str    | - | Срок действия. время в формате YYYYMMDhhmmss | "99991231235959" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Id | str    | + | идентификатор пользователя | "fab83a20-38fb-40ea-9fdf-6fd0befefd49" |
| UserName | str    | - | Логин | "Admin" |
| FullName | str    | - | Полное имя пользователя | "Администратор" |
| Vatin | str    | - | ИНН пользователя | "123456790" |
...
| Имя поля | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| UserName | str    | + | Логин | "artem" |
| Password | str    | + | Пароль | "Admin" |
| FullName | str    | - | Полное имя пользователя | "Челпанов Артем" |
| Vatin | str    | - | ИНН пользователя | "12345679012" |
| Role | int | + | код роли пользователя.  <br>Значения:  <br>0 - Администратор,  <br>1 - Сотрудник | 0 |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DocumentId | str    | + | идентификатор пользователя | "83f43a79-027c-449e-ab97-c3f2a4b6e81c" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DeviceName | str    | + | Имя устройства. Должно совпадать со значением поля **DeviceName**, указанным непосредственно в теле запроса. | "Atol" |
...
| IpAddress | str    | \- | IP-адрес. <br>Обязателен при MethodConnection=1 | "192.168.0.109" |
| TcpPort | int | \- | TCP-порт. <br>Обязателен при MethodConnection=1 | 7778 |
| Password | str    | + | Пароль устройства (пароль доступа к драйверу ККТ) | "30" |
| AccessPassword                    | str        | - | Пароль доступа к настройкам устройства (не путать с паролем устройства **Password**) | "0000" |                               |
| SerialNumber | str    | \- | Серийный номер устройства | "0392790042005043" |
| Vatin | str    | \- | ИНН организации | "7722345678" |
| OrganizationName | str    | \- | Название организации | "ООО Ромашка" |
| SaleAddress | str    | \- | Адрес расчётов | "г.Улан-Удэ, ул.Виноградная, д11А, офис 25" |
| ClientSaleLocation | str    | \- | Место расчётов | "Офис" |
| Cashier | str    | \- | ФИО кассира по умолчанию | "Иванов А.И." |
| CashierVatin | str    | \- | ИНН кассира | "7722345678" |
| SenderEmail | str    | \- | Email отправителя чека | "ivanov@mail.ru" |
...
| OfdAddress | str    | \- | Адрес ОФД | "ofd.example.ru" |
| OfdPort | int | \- | Порт ОФД | 7777 |
| Pool | str    | \- | Имя пула, в который включается устройство. <br><br>Если не указано — устройство не входит ни в один пул. | "pool" |

#### DeviceSettings

| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Name | str    | + | Название шаблона | "lines2" |
| TemplateSettingH1        | str      | - | Номер шрифта заголовка H1. Если не указано — ранее сохранённое значение стирается. | "1"          |
| TemplateSettingH2        | str      | -  | Номер шрифта заголовка H2. Если не указано — ранее сохранённое значение стирается. | "1"          |
| TemplateSettingH3        | str      | - | Номер шрифта заголовка H3. Если не указано — ранее сохранённое значение стирается. | "2"          |
| TemplateSettingH4        | str      | -  | Номер шрифта заголовка H4. Если не указано — ранее сохранённое значение стирается. | "2"          |
| TemplateSettingH5        | str      | -  | Номер шрифта заголовка H5. Если не указано — ранее сохранённое значение стирается. | "2"          |
...
| IpAddress                | str      | -        | IP-адрес прокси-сервера                                                            | "193.148.21.111"           |
| Port                     | int      | -        | Порт прокси-сервера                                                                | 67            |
| Name | str      | -        | Логин доступа к прокси-серверу. <br><br>Если поле не передано, ранее сохранённый логин будет затёрт пустым значением. | "ProxyServer"  |
| Password                 | str      | -        | Пароль доступа к прокси-серверу. <br><br>Если поле не передано, ранее сохранённый пароль будет затёрт пустым значением.| "ProxyPassword"           |

#### Cashier

| **Имя поля** | **Тип** | **Обяз** | **Назначение**                                                                            | **Пример**    |
| --- | --- | --- | --- | --- |
| Name         | str     | -        | Имя кассира. <br><br>Если не указано — подставляется имя из настроек ККТ, иначе «Кассир». | "Иванов А.И." |
| Vatin        | str     | -        | ИНН кассира. <br><br>Если не указан — ИНН кассира в чеке не печатается.                   | "7722345678"  |
...
| **Имя поля**     | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Info             | str     | -        | Наименование организации или фамилия, имя, отчество (при наличии). <br><br>Если не указано — в чек не попадает.       | "ООО 'Рога и Копыта'"                         |
| Email            | str     | -        | Электронная почта покупателя. <br><br>Если не указана — используется **Phone** (если указан).                         | "[kuznicov@mail.ru](mailto:kuznicov@mail.ru)" |
| Vatin            | str     | -        | ИНН покупателя. <br><br>Если не указан — ИНН покупателя в чек не попадает.                                            | "500100732259"                                |
| Phone            | str     | -        | Номер телефона. <br><br>Если не указан — используется **Email** (если указан).                                        | "+79021456776"                                |
| DateOfBirth      | str     | -        | Дата рождения покупателя (клиента) в формате "DD.MM.YYYY". <br><br>Если не указана — в чек не попадает.               | 01.01.1990                                    |
| Citizenship      | str     | -        | Код страны (ОКСМ). <br><br>Если не указан — в чек не попадает.                                                        | "643"                                         |
| DocumentTypeCode | str     | -        | Числовой код вида документа, удостоверяющего личность (ФФД, Таблица 116). <br><br>Если не указан — в чек не попадает. | "21"                                          |
| DocumentData     | str     | -        | Данные документа, удостоверяющего личность. <br><br>Если не указаны — в чек не попадают.                              | "Серия: 60 18 Номер: 345678"                  |
| Address          | str     | -        | Адрес покупателя. <br><br>Если не указан — в чек не попадает. | "г.Иркутск, ул.Апельсиновая, д31А, офис 15"   |
...
| Tax                         | str        | +        | Ставка НДС | "20" |
| MeasurementUnit             | str        | +        | Единица измерения предмета расчета | "шт"|
| DiscountSum                 | str        | -        | Сумма скидок и наценок | 0 |
...
| MarkingCode                 | str        | -        | Код контрольной марки. <br><br>Если не указан — код маркировки в позицию не передаётся (если не задан **GoodCodeData.MarkingCode**). | "MDEwNDYxMDE0NDA4NTM0MjIxNSVvIS1MVEVsQ2dBTB05MUVFMDkdOTJtdTlXR3VGK0hyQlFCR3ZUMTNneVc0d29uRmVqZ2FZd1YzSkhkN0U1VHhnPQ==" |
| AdditionalAttribute         | str        | -        | Дополнительный реквизит предмета расчет | "Доп информация: вода из Байкала" |
| CountryOfOrigin             | str        | -        | Цифровой код страны происхождения товара(ОКСМ) | "994"|
| CustomsDeclaration          | str        | -        | Регистрационный номер таможенной декларации | "06532/220211/0001122" |
...
| Description  | str     | -        | Описание (основание) коррекции. | "Основание коррекции"  |
| Date         | datetime | -        | Дата совершения корректируемого расчета. | "2026-03-30T00:00:00"  |
| Number       | str     | -        | Номер предписания налогового органа. Если коррекция самостоятельная (**Type** = 0), поле можно заполнить значением "0". | "0"  |

#### GoodCodeData

| **Имя поля**  | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| MarkingCode   | str     | -        | Код контрольной марки в кодировке Base64. <br><br>Если не указан — используется **MarkingCode** из **FiscalString** (если задан). | "MDEwNDYxMDE0NDA4NTM0MjIxNSVvIS1MVEVsQ2dBTB05MUVFMDkdOTJtdTlXR3VGK0hyQlFCR3ZUMTNneVc0d29uRmVqZ2FZd1YzSkhkN0U1VHhnPQ==" |
| Gtin          | str     | -        | GTIN. <br><br>Если не указан — в чек не попадает. | "04601234567890" |
| StampType     | str     | -        | Тип маркировки:<br>"02" — мех; <br>"05" — табак; <br>"1520" — обувь. <br><br>Если не указан — тег не передаётся. | "05" |
| Stamp         | str     | -        | КиЗ. <br><br>Если не указан — тег не передаётся. | "RU-ABC/1234567890123456" |
| SerialNumber  | str     | -        | Серийный номер. <br><br>Если не указан — тег не передаётся. | "5kX9mP2vQ7nR" |
| Barcode       | str     | -        | Штрихкод. <br><br>Если не указан — тег не передаётся. | "4601234567890" |
| NotIdentified | str     | -        | Код неидентифицированного формата в кодировке Base64. <br><br>Если не указан — не используется. | "U0tVLUxPQ0FMLTg4NDIx" |
| EAN8          | str     | -        | EAN-8 в кодировке Base64. <br><br>Если не указан — не используется.| "NDYwMTIzNDU=" |
| EAN13         | str     | -        | EAN-13 в кодировке Base64. <br><br>Если не указан — не используется. | "NDYwMTIzNDU2Nzg5MA==" |
| ITF14         | str     | -        | ITF-14 в кодировке Base64. <br><br>Если не указан — не используется. | "MTQ2MDEyMzQ1Njc4OTM=" |
| GS10          | str     | -        | GS10 (без маркировки) в кодировке Base64. <br><br>Если не указан — не используется. | "MDEwNDYwNDA2MDAwMzAxNQ==" |
| GS1M          | str     | -        | GS1 (с маркировкой) в кодировке Base64. <br><br>Если не указан — не используется. | "OTEwMjM0NTY3ODkwMTIzNDU2Nzg5MDEyMzQ1Ng==" |
| KMK           | str     | -        | Короткий код маркировки в кодировке Base64.<br><br>Если не указан — не используется. | "MDEwNDYwNDA2MDAwMzAxNTIxQWJDZEVm"|
| MI            | str     | -        | КиЗ мехового изделия. <br><br>Если не указан — не используется.  | "UlUtQUJDLzEyMzQ1Njc4OTAxMjM0NTY="  |
| EGAIS20       | str     | -        | ЕГАИС-2.0 в кодировке Base64. <br><br>Если не указан — не используется. | "MDEwMDAwMDAwMDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTIzNDU2Nzg5MDEyMzQ=" |
| EGAIS30       | str     | -        | ЕГАИС-3.0 в кодировке Base64. <br><br>Если не указан — не используется. | "MDMwMDAwMDAwMDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTIzNDU2Nzg5MDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTI="  |
| F1–F6         | str     | -        | Код формата Ф.1–Ф.6 в кодировке Base64. <br><br>Если не указан — не используется. | "RjEtREFUQS0wMDE=" |
...
| **Имя поля**  | **Тип** | **Обяз** | **Назначение**                                                      | **Пример**                             |
| --- | --- | --- | --- | --- |
| DateTime      | str     | -        | Дата и время операции. <br><br>Если не указано — тег не передаётся. | "03.07.2026"                           |
| OperationId   | str     | -        | Идентификатор операции. <br><br>Если не указан — тег не передаётся. | "24f4bffe-98ef-4627-846c-b1f74c5a495b" |
| OperationData | str     | -        | Данные операции. <br><br>Если не указаны — тег не передаётся.       | "Оплата по договору №784/2026"         |

#### VendorData

| **Имя поля** | **Тип**  | **Обяз** | **Назначение** | **Пример**  |
| --- | --- | --- | --- | --- |
| Phones       | list[str] | +        | Телефоны поставщика. Должен быть хотя бы один корректный российский номер (11 цифр). Сервер автоматически исправляет формат (удаляет лишние символы, заменяет 8 на 7). <br><br>Если после исправления ни одного валидного номера не осталось — ошибка "Телефон поставщика в строке чека N не некорректен". | [<br>"+79031234567", <br>"+79169876543"<br>] |
| Name         | str      | +  | Наименование поставщика. <br><br>Если пустой — ошибка "Наименование поставщика отсутствует в строке чека N".  | "ИП 'Ромашка'"  |
| Vatin        | str      | +        | ИНН поставщика. <br><br> Если пустой — ошибка "ИНН поставщика отсутствует в строке чека N". | "5262107639" |

#### TextString

| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Text         | str     | -        | Текст строки. Поддерживает префиксы перед текстом: `[big]`, `[small]`, `[bold]`, `[H1]`–`[H5]`, `[left]`, `[right]`, `[center]`, `[QR]`, `[line]`, `[line,dotted]`. Префикс `[line]` печатает разделительную линию вместо текста. URL в **Text** автоматически печатается как QR-код. Если пустой — строка пропускается (кроме префикса `[line]`). | "[big, center]Добро пожаловать" |
| Font         | str     | -        | Шрифт: Normal, Bold, Small, Medium, Big, H1–H5. <br><br>Если не указан — Normal. Префикс в **Text** имеет приоритет над **Font**. | "Big"   |
| Alignment    | str     | -        | Выравнивание: left, right, center, width. <br><br>Если не указано — left. Префикс в **Text** имеет приоритет над **Alignment**. | "left"  |
...
| Identifiers           | str     | -        | Идентификаторы безналичной оплаты (RRN, номер транзакции и т.п.). <br><br>Если не указан — тег не передаётся.  | "RRN=123456789012"         |
| AdditionalInformation | str     | -        | Доп. сведения об оплате. <br><br>Если не указаны — тег не передаётся. | "Терминал №1, карта *1234" |

#### IndustryAttribute

| **Имя поля**   | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| IdentifierFoiv | str     | -        | Идентификатор ФОИВ (тег 1262). Сервер дополняет 2-символьный код нулём слева до 3 символов ("30" станет "030").<br><br>Если не указан — тег не передаётся. | "3" |
| DocumentDate   | str     | -        | Дата документа-основания в формате "DD.MM.YYYY". <br><br>Если не указана — тег не передаётся.  | "01.07.2026"  |
| DocumentNumber | str     | -        | Номер документа-основания. <br><br>Если не указан — тег не передаётся. | "6" |
| AttributeValue | str     | -        | Идентификатор проверки кода маркировки. Для онлайн-проверки содержит параметры `UUID` и `Time`. Для офлайн-проверки дополнительно включает параметры Inst и Ver. Если значение не указано, тег не передаётся. | Онлайн: "UUID=fff5db9c-c0cb-4b1f-ac4b-8f0b92879780&Time=1746530733410". <br><br>Офлайн: "UUID=2ecabfd9-e863-46a4-aa4e-23b96508d804&Time=1784090059735&Inst=6e7ff224-0e08-41ed-844c-d386675f4e50&Ver=1ebf3971-5b24-403b-ae6d-8bb5a0383c14"|

#### AgentData

| **Имя поля**                 | **Тип**  | **Обяз** | **Назначение** | **Пример**                                  |
| --- | --- | --- | --- | --- |
| PayingAgentOperation         | str      | -        | Операция платежного агента (тег 1044). <br><br>Если не указана — в чек не попадает.| "Прием платежей"                            |
| PayingAgentPhone             | list[str] | -        | Телефон платежного агента (тег 1073). <br><br>Если не указан или массив пустой — тег не передаётся. <br><br>Некорректный формат — сервер попытается исправить; при неудаче — ошибка. | ["+79021654832"] |
| ReceivePaymentsOperatorPhone | list[str] | -        | Телефон оператора по приёму платежей (тег 1074). <br><br>Если не указан — тег не передаётся. <br><br>Некорректный формат — сервер попытается исправить; при неудаче — ошибка.  | ["+790216748367"]  |
| MoneyTransferOperatorPhone   | list[str] | -        | Телефон оператора перевода (тег 1075). <br><br>Если не указан — тег не передаётся ( и если не заполнены другие поля группы MoneyTransferOperator).                                   | ["+790216702167"]                           |
| MoneyTransferOperatorName    | str      | -        | Наименование оператора перевода (тег 1026). <br><br>Если не указано — тег не передаётся ( и если не заполнены другие поля группы MoneyTransferOperator).                             | "Иванов И.И."                               |
| MoneyTransferOperatorAddress | str      | -        | Адрес оператора перевода (тег 1005). <br><br>Если не указан — тег не передаётся ( и если не заполнены другие поля группы MoneyTransferOperator).                                     | "г.Улан-Удэ, ул.Виноградная, д11А, офис 25" |
| MoneyTransferOperatorVatin   | str      | -        | ИНН оператора перевода (тег 1016). <br><br>Если не указан — тег не передаётся ( и если не заполнены другие поля группы MoneyTransferOperator).                                       | "7722345678"                                |

#### UserAttribute

| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример**|
| --- | --- | --- | --- | --- |
| Name         | str     | +        | Название реквизита. <br><br>Если не указано — реквизит не передаётся. | "НомерЗаказа"   |
| Value        | str     | +        | Значение реквизита. <br><br>Если не указано — реквизит не передаётся. | "ORD-2026-0042" |

#### ApiBarcode

| **Имя поля** | **Тип** | **Обяз** | **Назначение**  | **Пример**                                 |
| --- | --- | --- | --- | --- |
| Type         | str     | +        | Тип штрихкода: UPCA,<br>CODE39, <br>EAN13, <br>EAN8, <br>UPCE, <br>ITF, <br>CODABAR, <br>CODE93, <br>CODE128, <br>PDF417, <br>CODE32, <br>QR. <br><br>Если не указан — позиция пропускается. | "QR" |
| Value        | str     | -        | Значение штрихкода в текстовом виде. <br><br>Обязательно **Value** или **ValueBase64**.<br><br>Если оба пустые — позиция пропускается. | "https://roga-i-kopyta.ru"  |
| ValueBase64  | str     | -        | Значение штрихкода в кодировке Base64. | "c2VjdXJlLXJhbmRvbS12YWx1ZS0xMjM0NTY3ODkw" |
| Alignment    | str     | -        | Выравнивание штрихкода:<br>left, <br>right, <br>center.<br><br>Если не указано — center. | "center" |

#### Picture

| **Имя поля** | **Тип** | **Обяз** | **Назначение**                                                                                                      | **Пример**       |
| --- | --- | --- | --- | --- |
| Value        | str     | +        | Изображение в Base64. <br><br>Если пустой — позиция пропускается.                                                   | "iVBORw0KGgo..." |
...
| Line | str    | - |Текст строки (левая часть) | "Текст" |
| LineRight | str    | - |Текст строки (правая часть) | "Информация" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Type | str    | + | Тип штрихкода.  <br>Возможные значения:  <br>UPCA,  <br>CODE39,  <br>EAN13,  <br>EAN8,  <br>UPCE,  <br>ITF,  <br>CODABAR,  <br>CODE93,  <br>CODE128,  <br>PDF417,  <br>CODE32,  <br>QR | "QR" |
| Value | str    | + | Значение штрихкода | "t=20260522T1506&s=50.00&fn=9999078902010507&i=343&fp=1352614355&n=1" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Guid | str    | - | Уникальный код запроса. Его можно описать для дальнейшего применения в запросе marking/km/confirm. | "46dc63e5-8efa-4da6-b8ee-d6188da7b26a" |
...
| MarkingCode | str    | + | Код маркировки в кодировке Base64. | "MDEwNDY3MDU0MDE3NjA5OTIxNSdXOVVtHTkzZEdWeg==" |
...
| Type | str    | - | Тип штрихкода.  <br>Возможные значения:  <br>UPCA,  <br>CODE39,  <br>EAN13,  <br>EAN8,  <br>UPCE,  <br>ITF,  <br>CODABAR,  <br>CODE93,  <br>CODE128,  <br>PDF417,  <br>CODE32,  <br>QR | "QR" |
| Value | str    | - | Значение штрихкода | "t=20260522T1506&s=50.00&fn=9999078902010507&i=343&fp=1352614355&n=1" |
| PictureBase64 | str    | - | Изображение штрихкода, закодированное в Base64 | "iVBORw0KGgoAAAANSUhEUgAAAH0AAAB9CAIAAAAA4vtyAAAA..." |
...
| FiscalizationDocumentNumber | str    | - | Номер документа регистрация фискального накопителя | "0" |
...
| LivePhase | str    | - | Фаза жизни ФН: <br>init - настройка ФН; <br>configured - настроен, готов в активации; <br>fiscalMode - фискальный режим; <br>postFiscalMode - постфискальный режим; <br>accessArchive - доступ к архиву ФН; <br>unknown - неизвестная фаза жизни | "fiscalMode" |
| Version | str    | - | Версия ФН | "1.0" |
| RnNumber | str    | - | Регистрационный номер ККТ | "00031415926" |
| FnsUrl | str    | - | Адрес сайта уполномоченного органа(ФНС) в сети «Интернет» | "nalog.ru" |
| SenderEmail | str    | - | Адрес электронной почты отправителя чека | "ivanov@mail.ru" |
| FfdVersion | str    | - | Версия ФФД ФН | "1.2" |
| SerialNumber | str    | - | Серийный номер ФН | "0123123123123" |
| OrganizationName | str    | - | Название организации | "ООО 'Ромашка'" |
| Vatin | str    | - | ИНН организации | "7722345678" |
| ValidityDate | datetime | - | Срок действия ФН | "2027-06-08T17:22:38.2396579+08:00" |
| SaleAddress | str    | - | Адрес установки ККТ для проведения расчетов | "г.Улан-Удэ, ул.Виноградная, д11А, офис 25" |
| SaleLocation | str    | - | Место проведения расчетов | "Офис" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Name | str    | - | Имя ОФД | "Тестовый ОФД" |
| Vatin | str    | - | ИНН ОФД | "1234554321" |
| Host | str    | - | Адрес сервера ОФД | "ofd.example.ru" |
...
| --- | --- | --- | --- | --- |
| FfdVersion | str    | - | Версия ФФД | "1.2 |
| FnFfdVersion | str    | - | Версия ФФД ФН | "1.2" |
...
| KktLicenses | list[[KktLicenseInfo](#kktlicenseinfo)] | - | Массив лицензий ККТ | \[\] |
| IsFiscal | bool | - | Фискальный режим | true |
...
| SerialNumber | str    | - | Заводской номер ККТ | "0020260207" |
| FirmwareVersion | str    | - | Версия прошивки | "2026" |
| ConfigurationVersion | str    | - | Версия конфигурации прошивки устройства | "02.07" |

#### DriverInfo

| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Type | str    | - | Тип драйвера | "Atol" |
| Version | str    | - | Версия драйвера | "26.01.27" |
| Vendor | str    | - | Данные поставщика | "Atol" |
...
| LineLength | int | - | Ширина чековой ленты | 42 |
| LineLengthPixels | int | - | Ширина чековой ленты в пикселях | 512 |
| TaskId | str    | - | Идентификатор текущей задачи | "00000000-0000-0000-0000-000000000000" |
| Error | int | - | Код ошибки | 0 |
| ErrorCodeDescription | str    | - | Описание ошибки устройства по данным драйвера | "OK" |
| DriverMode | int | - | Режим по данным драйвера | 0 |
| DriverModeDescription | str    | - | Описание режима Mode по данным драйвера | "" |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Address       | str      | - | Адрес сервера информационной системы маркировки        | "ism.example.ru" |
...
| Description | str    | - | Описание ошибки | "Нет ошибок" |
...
| IpAddress | str    | - | IP-адрес прокси | "193.148.21.111" |
| Port | int | - | Порт прокси | 67 |
| Name | str    | - | Логин к прокси-серверу | "ProxyName" |
| Password | str    | - | Пароль к прокси-серверу | "ProxyPassword" |
...
| LineLengthPixels | int | - | Ширина чековой ленты в пикселях | 0 |
| DeviceClass | int | - | Тип устройства: <br>1 — Принтер; <br>2 — Чековый принтер;  <br>3 — Фискальный регистратор (не онлайн-ккм); <br>4 — Онлайн-ккм, применяемая в РФ в соответствии с ФЗ-54; <br>5 — Эквайринговый терминал  <br>6 — Терминал сбора данных; <br>7 — Электронные весы; <br>8 — Электронные весы с печатью этикеток; <br>9 — Сканер штрихкодов | 7 |
| Model | str    | - | Название модели | АТОЛ FPrint-22ПТК |
| SerialNumber | str    | - | Заводской номер ККТ | "0020260207" |
| FirmwareVersion | str    | - | Версия прошивки | "2026" |
| ConfigurationVersion | str    | - | Версия конфигурации прошивки устройства | "02.07" |
...
| Name | str    | - | Наименование лицензии | "Лицензия №1" |
...
| UnitVersion | str    | - | Максимально поддерживаемая конфигурация. | "5.14" |
| Description | str    | - | Описание последствий окончания лицензии | "Лицензия истекла!" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| DepartmentTotals | list[DepartmentTotals] | - | Показатели отдела за смену | \[\] |
| NumberOfChecks | int | - | Количество кассовых чеков за смену | 1 |
| NumberOfDocuments | int | - | Количество общее ФД за смену | 1 |
...
| **Имя параметра** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| OrganizationInfo | str    | - | Название организации | "ООО 'Ромашка'" |
| SerialNumber | str    | - | Заводской номер ККТ | "00106305393630" |
| Vatin | str    | - | ИНН Организации | "7722345678" |
| Cashier | str    | - | Кассир | "Иванов А.И." |
| RnNumber | str    | - | Регистрационный номер ККТ | "0000000002005725" |
| Fn | str    | - | Фискальный накопитель | "0123123123123" |
| FnsUrl | str    | - | Адрес сайта уполномоченного органа (ФНС) в сети «Интернет» | "nalog.ru" |
| ShiftNumber | int | - | Номер смены | 39 |
| DocNumber | int | - | Номер фискального документа | 343 |
| FiscalSign | str    | - | Фискальный признак документа | "1352614355" |
| OfdOrganizationName | str    | - | Наименование провайдера ОФД | Тестовый ОФД |
| OfdVatin | str    | - | ИНН провайдера ОФД | 7709364346 |
...
| ShiftNumber | float  | + | Номер смены | 3.0 |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Name | str    | - | Название | Бутылка с водой 1л." |
| Quantity | Decimal | - | Количество товара | 1 |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| Info | str    | - | Наименование организации или фамилия, имя, отчество (при наличии) | "ООО 'Рога и Копыта'" |
| Inn | str    | - | ИНН организации или покупателя (клиента) | "500100732259" |
| Email | str    | - | Электронная почта | "kuznicov@mail.ru" |
...
| Fn | str    | - | Фискальный накопитель | "1234554321" |
| Fd | int | - | Фискальный документ | 370 |
| Fp | str    | - | Фискальный признак | "2928907410" |
| Fd | int | - | Фискальный документ | 370 |
...
| Scale | int | - | Масштаб | 100 |
| Line | str    | - | Текст строки (левая часть) | "Кассовый чек" |
| LineRight | str    | - | Текст строки (правая часть) | "" |
| Alignment | int | - | Выравнивание.  <br>0 — выравнивание по левому краю;  <br>1 — Выравнивание по центру;  <br>2 — Выравнивание по правому краю;  <br>3 — По ширине | 1 |
...
| Description | str    | - | Описание коррекции | "Основание" |
| Date | datetime | - | Дата совершения корректируемого расчета | "2026-05-24T00:11:23.5221437+08:00" |
| Number | str    | - | Номер предписания налогового органа | "0" |
...
| **Имя поля** | **Тип** | **Обяз** | **Назначение** | **Пример** |
| --- | --- | --- | --- | --- |
| PictureBase64 | str    | + | Изображение закодированное в Base64 | "iVBORw0KGgoAAAANSUhEUgA..." |
| Alignment | int | - | Выравнивание: <br>1 - по левому краю;  <br>2 - по центру;  <br>3 - по правому краю. | 2 |
| Width | int | - | Ширина изображения при печати, в точках | 200 |
| Height | int | - | Высота изображения при печати, в точках | 80 |
| StartLineNumber | int | - | Номер первой строки печати изображения | 0 |
...
| --- | --- | --- | --- |
| cis                | str       | - | Полный код маркировки | "0104670540176099215'W9Um93dGVz" |
...
| message                | str       | - | Сообщение об ошибке | null |
...
| ogvs | list[str] | - | Органы государственной власти, установившие блокировку кода (заполняется при **isBlocked** = true): <br>RAR — Росалкогольрегулирование; <br>FTS — ФТС России; <br>FNS — ФНС России; <br>RSHN — Россельхознадзор; <br>RPN — Роспотребнадзор; <br>MVD — МВД России; <br>RZN — Росздравнадзор.  | [] |
...
| CheckItems      | list[[CheckItem](#checkitem)] | -        | Позиции шаблона                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | \[\]                                                                                                   |
...
| BaseDocId         | str                       | –        | Id документа-основания (для связывания операций в цепочку)                                                                                                                                                                                                                                                                                                                                                   | "914a7c5c-4233-4dab-b839-eccefefe3421" |
| TerminalId        | str                       | +        | Идентификатор терминала, с которого пришёл документ                                                                                                                                                                                                                                                                                                                                                          | "WEB_Admin_127.0.0.1"                  |
| RequestId         | str                       | –        | Идентификатор запроса на запись документа (заголовок `x-request-id`); защита от повторной записи                                                                                                                                                                                                                                                                                                             | "…"                                    |
| DeviceName        | str                       | +        | Имя устройства                                                                                                                                                                                                                                                                                                                                                                                               | "Emu"                                  |
| PoolId            | str                       | –        | Пул, назначенный документу (печать на любой ККМ пула)                                                                                                                                                                                                                                                                                                                                                        | ""                                     |
| ResultCode        | int                       | +        | Код результата (`0` — успех)                                                                                                                                                                                                                                                                                                                                                                                 | 0                                      |
| ResultDescription | str                       | +        | Описание результата                                                                                                                                                                                                                                                                                                                                                                                          | "OK"                                   |
| Processed         | bool                      | +        | Признак удачного завершения обработки                                                                                                                                                                                                                                                                                                                                                                        | true                                   |
| ClientVersion     | str                       | –        | Версия клиента (драйверы 1С прописывают свою)                                                                                                                                                                                                                                                                                                                                                                | null                                   |
| ServerVersion     | str                       | +        | Версия сервера (проставляется автоматически)                                                                                                                                                                                                                                                                                                                                                                 | "4.0.70.827"                           |
