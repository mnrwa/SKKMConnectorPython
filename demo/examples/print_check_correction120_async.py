...
class PrintCheckCorrection120Async(Sample):
    GroupPath = "Работа с ККМ|Корректировочные чеки|Корректировки ФФД 1.2"
    Title = "Асинхронная печать коррекции 1.2"

    def PostPrintCheckCorrection120Async(self) -> SkkmConnector:
        kkm = self.kkm
        ...
        kkm.PrintCheckCorrection120Async()
