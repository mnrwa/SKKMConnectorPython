...
class PrintCheckCorrection105Async(Sample):
    GroupPath = "Работа с ККМ|Корректировочные чеки|Корректировки ФФД 1.0.5"
    Title = "Асинхронная печать коррекции 1.0.5"

    def PostPrintCheckCorrection105Async(self) -> SkkmConnector:
        kkm = self.kkm
        ...
        kkm.PrintCheckCorrection105Async()
